...
**Next:** Stage 6 — UI / workspace (Supplier Map list colours/filters; 3 number cards into the §17 worklist row; buttons wired; delta-pull cron at scheduled hour — vendors HAVE updated_after so this is a real delta, not full-pull).
