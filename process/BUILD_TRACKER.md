...
5. Push-side deactivate endpoint exists? — still **OPEN** (Stage 5).

**Next:** Stage 5 — lifecycle / flip / drift detection (mirror §8d/§8e — push-side deactivate endpoint check, post-flip drift detection, Dismiss/Push-ERPNext→EE actions, no Accept-EE).
